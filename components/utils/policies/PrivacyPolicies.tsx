...
const PrivacyPolicies = () => {
    const title = {
        1: "What We Collect (and How it is Used and Shared)",
    }
  return (
    <div className='bg-white text-reddit_dark'>
      <div className="md:flex py-8 px-2">
        <div className="w-full md:w-[40%] lg:w-[25%] font-bold lg:block flex-none pt-10 lg:mr-[100px]">
            <div>
                <p>Jump to</p>
                <div className="list-disc mx-4 font-normal text-[14px]">
                    <li>
                        <button className="text-reddit_blue hover:underline">
                            {title[1]}
                        </button>
                    </li>
                </div>
        ...
        <div className="pt-12 md:pt-8">
          ...
          <h2 className="pt-4 text-[14px]">Effective May 15,2022. Last Revised May 15,2022</h2>
          <h3 className="mr-0 p-8 pl-0 text-sm lg:mr-12">
            ...
            interact with us or receive a communication from us. This Privacy
            Policy applies to all of our Services including Bbaby Gifts, which
            maintains a separate privacy notice that incorporates this Privacy
            Policy by reference.
          </h3>
          <h2 className="text-2xl font-bold">What We Collect (and How it is Used and Shared)</h2>
          <div className="mr-0 border border-reddit_border pl-0 text-sm lg:mr-24">
            <div className='p-8'>
                <h1 className="underline">Information You Provide to Us</h1>
                <h2 className="p-2 pt-0 pl-0">We collect information you provide to us directly when you use the Services. This includes:</h2>
            </div>
            <h3 className="p-2 pl-0 text-xl font-bold">Log Data</h3>
            <h4>
            ...
            <h5 className="p-2 pl-0 text-xl font-bold">Personal Information</h5>
            <h6>
            ...
            <div className="p-4 pl-0 text-xl font-bold">
              <h1>
            ...
            <div className="list-disc">
              <li className="p-2 pl-4 font-bold">
            ...
            <div>
              <h1 className="p-2 pl-0">
                ...
                link by which you are accessing this privacy policy. If required
                by law, we will get your permission or give you the opportunity
                to opt in to or opt out of, as applicable, any new uses of your
